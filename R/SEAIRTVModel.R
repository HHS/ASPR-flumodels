                         ...
                         simulationLength, seedStartDay, tolerance, method)
{
    ...
    with(append(stateList, parameters),
         {
           ...
           print("I:")
           print(I)
           print("fractionSymptomatic:")
           print(fractionSymptomatic)
           print("relativeInfectivityAsymptomatic:")
           print(relativeInfectivityAsymptomatic)
           
           element_1 <- beta / populationFractions
           element_2 <- (fractionSymptomatic + relativeInfectivityAsymptomatic - fractionSymptomatic * relativeInfectivityAsymptomatic)
           element_3 <- element_1/element_2
           element_4 <- A + I
           element_5 <- (1 - fractionSymptomatic) * relativeInfectivityAsymptomatic
           element_6 <- element_4*element_5
           element_7 <- fractionSymptomatic * (A + Av*(1 - VEi) * (1 - VEp))
           element_8 <- (1 - AVEi.eff) * fractionSymptomatic * (I + Iv * (1 - VEi) * (1 - VEp))
           element_9 <- (Av + Iv) * relativeInfectivityAsymptomatic * (1 - VEi) * (1 - fractionSymptomatic + fractionSymptomatic * VEp)
           element_11 <- (element_6 + element_7 + element_8 + element_9)
           print("element_11:")
           print(element_11)
           print("element_11_check:")
           print((
           ...
           print("VEs:")
           print(VEs)
           element_10 <- element_3*contactMatrix %*% element_11
  ...
  checkInputs.Antiviral <- function(populationFractions, fractionSymptomatic = 0.5,  fractionSeekCare = 0.6,
    ...
    print("AVEi.eff calculation elements:")
    print(AVEi)
    print(fractionAdhere)
    print(fractionDiagnosedAndPrescribedOutpatient)
    print(fractionSeekCare)
    print(fractionSymptomatic)
